...
def vector_embedding(pdf_file):
    if "vectors" not in st.session_state:
        st.session_state.vectors = None  # Initialize it to None or any default value
...
if prompt1:
    if "vectors" in st.session_state:  # Check if vectors have been initialized
        ...
        st.warning("Please upload a document and generate the vector store first.")
